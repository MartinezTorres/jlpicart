...
//   │ CONTENT_INDEX  (reserved)    │ 0x300000     │  3 MB  (0x300000)  │
...
static constexpr uint32_t FLASH_CONTENT_INDEX_OFS  = 0x300000u;
static constexpr uint32_t FLASH_CONTENT_INDEX_SIZE = 0x300000u;  // 3 MB (reserved)
...
static_assert(FLASH_EVENT_LOG_OFS + FLASH_EVENT_LOG_SIZE == FLASH_CONTENT_INDEX_OFS,
              "CONTENT_INDEX must immediately follow EVENT_LOG");
