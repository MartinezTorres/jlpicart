...
/*
using VGA640x480 = CRT< // 302 MHz
    640, 16, 96, 48, H_POLARITY_NEGATIVE, // size_t H_VISIBLE_AREA, size_t H_FRONT_PORCH, size_t H_SYNC_PULSE, size_t H_BACK_PORCH, bool H_POLARITY_POSITIVE,
    480, 10,  2, 33, V_POLARITY_NEGATIVE, // size_t V_VISIBLE_AREA, size_t V_FRONT_PORCH, size_t V_SYNC_PULSE, size_t V_BACK_PORCH, bool V_POLARITY_POSITIVE,
    12, 1, VGA_H_V_SYNC, NON_INTERLACED>; // size_t BPP, size_t CLOCK_DIVIDER, ESync SYNC, EInterlace INTERLACED>


using VGA1152x862_100Hz = CRT< //  1434 / 5 = 286.8 MHz 
    1152, 80, 128, 208, H_POLARITY_NEGATIVE, // size_t H_VISIBLE_AREA, size_t H_FRONT_PORCH, size_t H_SYNC_PULSE, size_t H_BACK_PORCH, bool H_POLARITY_POSITIVE,
    864, 1,  3, 47, V_POLARITY_POSITIVE, // size_t V_VISIBLE_AREA, size_t V_FRONT_PORCH, size_t V_SYNC_PULSE, size_t V_BACK_PORCH, bool V_POLARITY_POSITIVE,
    2, 1, VGA_H_V_SYNC, NON_INTERLACED>; // size_t BPP, size_t CLOCK_DIVIDER, ESync SYNC, EInterlace INTERLACED>

using VGA288x862_100Hz = CRT< //  1434 / 5 = 286.8 MHz 
    1152/4, 80/4, 128/4, 208/4, H_POLARITY_NEGATIVE, // size_t H_VISIBLE_AREA, size_t H_FRONT_PORCH, size_t H_SYNC_PULSE, size_t H_BACK_PORCH, bool H_POLARITY_POSITIVE,
    864, 1,  3, 47, V_POLARITY_POSITIVE, // size_t V_VISIBLE_AREA, size_t V_FRONT_PORCH, size_t V_SYNC_PULSE, size_t V_BACK_PORCH, bool V_POLARITY_POSITIVE,
    2*4, 1, VGA_H_V_SYNC, NON_INTERLACED>; // size_t BPP, size_t CLOCK_DIVIDER, ESync SYNC, EInterlace INTERLACED>

using VGA288x862_75Hz = CRT< //  1296 / 4 = 324 MHz 
    1152/4, 64/4, 128/4, 256/4, H_POLARITY_POSITIVE, // size_t H_VISIBLE_AREA, size_t H_FRONT_PORCH, size_t H_SYNC_PULSE, size_t H_BACK_PORCH, bool H_POLARITY_POSITIVE,
    864, 1,  3, 32, V_POLARITY_POSITIVE, // size_t V_VISIBLE_AREA, size_t V_FRONT_PORCH, size_t V_SYNC_PULSE, size_t V_BACK_PORCH, bool V_POLARITY_POSITIVE,
    3*4, 1, VGA_H_V_SYNC, NON_INTERLACED>; // size_t BPP, size_t CLOCK_DIVIDER, ESync SYNC, EInterlace INTERLACED>

using VGA1280x1024_60Hz = CRT< //  1296 / 4 = 324 MHz 
    1280, 48, 112, 248, H_POLARITY_POSITIVE, // size_t H_VISIBLE_AREA, size_t H_FRONT_PORCH, size_t H_SYNC_PULSE, size_t H_BACK_PORCH, bool H_POLARITY_POSITIVE,
    1024, 1,  3, 38, V_POLARITY_POSITIVE, // size_t V_VISIBLE_AREA, size_t V_FRONT_PORCH, size_t V_SYNC_PULSE, size_t V_BACK_PORCH, bool V_POLARITY_POSITIVE,
    3, 1, VGA_H_V_SYNC, NON_INTERLACED>; // size_t BPP, size_t CLOCK_DIVIDER, ESync SYNC, EInterlace INTERLACED>

using VGA320x1024_60Hz = CRT< //  1296 / 4 = 324 MHz 
    1280/4, 48/4, 112/4, 248/4, H_POLARITY_POSITIVE, // size_t H_VISIBLE_AREA, size_t H_FRONT_PORCH, size_t H_SYNC_PULSE, size_t H_BACK_PORCH, bool H_POLARITY_POSITIVE,
    1024, 1,  3, 38, V_POLARITY_POSITIVE, // size_t V_VISIBLE_AREA, size_t V_FRONT_PORCH, size_t V_SYNC_PULSE, size_t V_BACK_PORCH, bool V_POLARITY_POSITIVE,
    3/4, 1, VGA_H_V_SYNC, NON_INTERLACED>; // size_t BPP, size_t CLOCK_DIVIDER, ESync SYNC, EInterlace INTERLACED>


using VGA1920x1440 = CRT< //  1188/4 =297 MHz 
    1920, 144, 224, 352, H_POLARITY_NEGATIVE, // size_t H_VISIBLE_AREA, size_t H_FRONT_PORCH, size_t H_SYNC_PULSE, size_t H_BACK_PORCH, bool H_POLARITY_POSITIVE,
    1440, 1,  3, 56, V_POLARITY_POSITIVE, // size_t V_VISIBLE_AREA, size_t V_FRONT_PORCH, size_t V_SYNC_PULSE, size_t V_BACK_PORCH, bool V_POLARITY_POSITIVE,
    1, 1, VGA_H_V_SYNC, NON_INTERLACED>; // size_t BPP, size_t CLOCK_DIVIDER, ESync SYNC, EInterlace INTERLACED>

using VGA32x1440 = CRT< // 1188/4 =297 MHz 
    1920/4, 144/4, 224/4, 352/4, H_POLARITY_NEGATIVE, // size_t H_VISIBLE_AREA, size_t H_FRONT_PORCH, size_t H_SYNC_PULSE, size_t H_BACK_PORCH, bool H_POLARITY_POSITIVE,
    1440, 1,  3, 56, V_POLARITY_POSITIVE, // size_t V_VISIBLE_AREA, size_t V_FRONT_PORCH, size_t V_SYNC_PULSE, size_t V_BACK_PORCH, bool V_POLARITY_POSITIVE,
    4, 1, VGA_H_V_SYNC, NON_INTERLACED>; // size_t BPP, size_t CLOCK_DIVIDER, ESync SYNC, EInterlace INTERLACED>


using VGA800 = CRT< // 320 MHz
    800, 40, 128, 88, H_POLARITY_POSITIVE, // size_t H_VISIBLE_AREA, size_t H_FRONT_PORCH, size_t H_SYNC_PULSE, size_t H_BACK_PORCH, bool H_POLARITY_POSITIVE,
    600,  1,   4, 23, V_POLARITY_POSITIVE, // size_t V_VISIBLE_AREA, size_t V_FRONT_PORCH, size_t V_SYNC_PULSE, size_t V_BACK_PORCH, bool V_POLARITY_POSITIVE,
    8, 1, COMPOSITE_SYNC_DISABLED>; // size_t BPP, size_t PIXEL_CLOCK_DIVIDER, CompositeSync COMPOSITE_SYNC>

using VGA1152 = CRT< // 326.666 MHz
    1152, 64, 120, 184, H_POLARITY_NEGATIVE, // size_t H_VISIBLE_AREA, size_t H_FRONT_PORCH, size_t H_SYNC_PULSE, size_t H_BACK_PORCH, bool H_POLARITY_POSITIVE,
     864,  1,   3,  27, V_POLARITY_POSITIVE, // size_t V_VISIBLE_AREA, size_t V_FRONT_PORCH, size_t V_SYNC_PULSE, size_t V_BACK_PORCH, bool V_POLARITY_POSITIVE,
    4,  1, COMPOSITE_SYNC_DISABLED>; // size_t BPP, size_t PIXEL_CLOCK_DIVIDER, CompositeSync COMPOSITE_SYNC>

using VGA1280x1024_75Hz = CRT< // 270 MHz
    1280, 16, 144, 248, H_POLARITY_POSITIVE, // size_t H_VISIBLE_AREA, size_t H_FRONT_PORCH, size_t H_SYNC_PULSE, size_t H_BACK_PORCH, bool H_POLARITY_POSITIVE,
    1024,  1,   3,  38, V_POLARITY_POSITIVE, // size_t V_VISIBLE_AREA, size_t V_FRONT_PORCH, size_t V_SYNC_PULSE, size_t V_BACK_PORCH, bool V_POLARITY_POSITIVE,
    1,  2, COMPOSITE_SYNC_DISABLED>; // size_t BPP, size_t PIXEL_CLOCK_DIVIDER, CompositeSync COMPOSITE_SYNC>

using VGA1280x1024_85Hz = CRT< // 315 MHz
    1280, 64, 160, 224, H_POLARITY_POSITIVE, // size_t H_VISIBLE_AREA, size_t H_FRONT_PORCH, size_t H_SYNC_PULSE, size_t H_BACK_PORCH, bool H_POLARITY_POSITIVE,
    1024,  1,   3,  44, V_POLARITY_POSITIVE, // size_t V_VISIBLE_AREA, size_t V_FRONT_PORCH, size_t V_SYNC_PULSE, size_t V_BACK_PORCH, bool V_POLARITY_POSITIVE,
    1,  2, COMPOSITE_SYNC_DISABLED>; // size_t BPP, size_t PIXEL_CLOCK_DIVIDER, CompositeSync COMPOSITE_SYNC>


// SCART modes
// https://www.rigacci.org/docs/biblio/online/scart/scart3/scart-pinout.html
// https://www.batsocks.co.uk/readme/video_timing.htm
// https://www.hdretrovision.com/blog/2019/10/10/engineering-csync-part-2-falling-short // Info on CSYNC

using SCART720x480_50i = CRT< //  "720x480" 15.101 720 770 842 968 480 505 510 564 interlace +hsync +vsync
    720, 50, 72, 126, H_POLARITY_POSITIVE, // size_t H_VISIBLE_AREA, size_t H_FRONT_PORCH, size_t H_SYNC_PULSE, size_t H_BACK_PORCH, bool H_POLARITY_POSITIVE,
    480, 25,  5,  54, V_POLARITY_POSITIVE, // size_t V_VISIBLE_AREA, size_t V_FRONT_PORCH, size_t V_SYNC_PULSE, size_t V_BACK_PORCH, bool V_POLARITY_POSITIVE,
    1,  2, COMPOSITE_SYNC_ENABLED>; // size_t BPP, size_t PIXEL_CLOCK_DIVIDER, CompositeSync COMPOSITE_SYNC>

using SCART720x480_50i = CRT< //  "720x576" 15.125 720 778 834 968 576 579 607 625 composite interlace +hsync +vsync
    720, 58, 56, 134, H_POLARITY_POSITIVE, // size_t H_VISIBLE_AREA, size_t H_FRONT_PORCH, size_t H_SYNC_PULSE, size_t H_BACK_PORCH, bool H_POLARITY_POSITIVE,
    576, 3,  28,  18, V_POLARITY_POSITIVE, // size_t V_VISIBLE_AREA, size_t V_FRONT_PORCH, size_t V_SYNC_PULSE, size_t V_BACK_PORCH, bool V_POLARITY_POSITIVE,
    1,  2, COMPOSITE_SYNC_ENABLED>; // size_t BPP, size_t PIXEL_CLOCK_DIVIDER, CompositeSync COMPOSITE_SYNC>
*/
...
/*template<typename T>
static void init_msx1_palette( T &video_device ) {
    ...
    for (int i=0; i<16; i++)
        video_device.set_palette(i, rgb[i][0], rgb[i][1], rgb[i][2]);
}


uint8_t border_color;
uint8_t framebuffer[192][256];
uint8_t linebuffer[640];
...
void vga640_init() {
    ...
    vga([&](uint16_t line){ 
        ...
        if (line < 192) {
            for (int i=0; i<256; i++) {
                linebuffer[ (320-256)/2 + i ] = framebuffer[line][i];
            }
        } else {
            for (int i=0; i<320; i++)
                linebuffer[i] = border_color;
        }
    ...
    init_msx1_palette(vga);

    putstring("   PALETTE INITIALIZED\n");

    multicore_launch_core1(vga640_entry);
