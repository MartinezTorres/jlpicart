...
namespace I2C {
    ...
    namespace Private {
        ...
        void sda_high() { gpio_set_dir( GPIO37_OLEDSDA, GPIO_IN ); };
        void sda_low()  { gpio_set_dir( GPIO37_OLEDSDA, GPIO_OUT ); };
        void scl_high() { gpio_set_dir( GPIO38_OLEDSCK, GPIO_IN ); };
        void scl_low()  { gpio_set_dir( GPIO38_OLEDSCK, GPIO_OUT ); };

        void init() {

            gpio_init(GPIO38_OLEDSCK); 
            gpio_set_drive_strength(GPIO38_OLEDSCK, GPIO_DRIVE_STRENGTH_8MA);
            gpio_set_slew_rate(GPIO38_OLEDSCK, GPIO_SLEW_RATE_FAST);
            gpio_put(GPIO38_OLEDSCK, false);
            scl_high();
            
            gpio_init(GPIO37_OLEDSDA);
            gpio_set_drive_strength(GPIO37_OLEDSDA, GPIO_DRIVE_STRENGTH_8MA);
            gpio_set_slew_rate(GPIO37_OLEDSDA, GPIO_SLEW_RATE_FAST);
            gpio_put(GPIO37_OLEDSDA, false);
            sda_high();
        }
